...
function updateTables() {
   ...
   for (var i=0; i < data.length; i++) {
      if (data[i].playing) document.getElementById("nodes").innerHTML += "<tr><td>" + data[i].name + "</td><td>Yes</td><td><input type='checkbox' id='p" + data[i].name + "'></input></td><td><input type='text' value='" + data[i].song + "' id='a" + data[i].name + "'></input></td><td><td><input id='v" + data[i].name + "' value='" + Math.sqrt(data[i].volume)*100 + "' onclick=\"volume_update('v" + data[i].name + "')\" type='range' min='0' max='100'></td><td><span id ='cd" + data[i].name + "'></span></td></tr>"
